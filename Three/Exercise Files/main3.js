function init() {
	...
	// initialize objects
	var sphereMaterial = getMaterial('standard', 'rgb(255, 0, 0)');
	var sphere = getSphere(sphereMaterial, 1, 24);

	var planeMaterial = getMaterial('standard', 'rgb(0, 0, 255)');
